...
CREATE_SCHEDULE_SCHEMA = vol.Schema(
    {
        **BASE_SERVICE_SCHEMA,
        ...
        vol.Optional(ATTR_TRIGGER_MODE): vol.In(TRIGGER_MODES),
        vol.Optional(ATTR_HEBCAL_EVENT_KIND): vol.In(HEBCAL_EVENT_KINDS),
...
async def _async_register_services(hass: HomeAssistant) -> None:
    ...
    async def _create_schedule(call: ServiceCall) -> None:
        ...
        await manager.async_create_task(
            ...
            hebcal_event_kind=call.data.get(ATTR_HEBCAL_EVENT_KIND),
