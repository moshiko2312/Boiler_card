...
export function buildThemeCss() {
  return `
        ...
        :host([data-card-theme="dark-glass"]) .schedule-dropdown-toggle,
        ...
        :host([data-card-theme="amber-glow"]) .schedule-dropdown-toggle,
        ...
        :host([data-card-theme="smart-room-blue"]) .schedule-dropdown-toggle,
        ...
        :host([data-card-theme="midnight-black"]) .schedule-dropdown-toggle,
        ...
        :host([data-card-theme="frost-light"]) .schedule-dropdown-toggle,
        ...
        :host([data-card-theme="clear-frost"]) .schedule-dropdown-toggle,
